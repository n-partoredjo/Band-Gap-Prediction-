...
class MultipleRegression(nn.Module):
    def __init__(self, num_features):
        ...
        self.layer_7 = nn.Linear(100,100)
        self.layer_8 = nn.Linear(100,100)
        self.layer_9 = nn.Linear(100,100) 
        self.layer_10 = nn.Linear(100,100)
...
bounds = np.linspace(np.min(difference), np.max(difference), 4)
